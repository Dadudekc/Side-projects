...
import pytest
import json
from debugger.debug_agent_auto_fixer import DebugAgentAutoFixer
...
def test_fix_test_imports(auto_fixer):
    ...
    with open(test_file_path, "w", encoding="utf-8") as file:
        file.write("from agents.core.DebuggerCore import DebuggerCore import DebuggerCore\n")
        file.write("from agents.core.DebuggerCLI import DebuggerCLI import DebuggerCLI\n")
