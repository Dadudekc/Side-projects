...
class AIPatchOptimizer:
    ...
    def refine_failed_patch(self, error_signature: str, original_patch: str) -> Optional[str]:
        ...
        # Only attempt the new patch if confidence improves over the current best
    ...
    def _modify_patch(self, patch: str) -> str:
        ...
        for mod in modifications:
            ...
            if new_patch != patch:
                ...
                return new_patch
        # If no modification applies, return original patch (should rarely happen)
        logger.debug("🔧 No modification applied; returning original patch.")
        return patch
    ...
    def attempt_patch_reapply(self, error_signature: str, test_file: str, original_patch: str) -> bool:
        ...
        # Apply the modified patch using the AI model.
