...
from agents.core.utilities.auto_fixer import AutoFixer
from agents.core.utilities.debug_agent_utils import DebugAgentUtils
from agents.core.utilities.learning_db import LearningDB
...
class TestAutoFixer(unittest.TestCase):
    ...
    @patch("agents.core.utilities.debug_agent_utils.DebugAgentUtils.parse_diff_suggestion", return_value=[{"path": "test_sample.py"}])
