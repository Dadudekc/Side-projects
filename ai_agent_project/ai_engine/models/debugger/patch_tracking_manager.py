...
class PatchTrackingManager:
    ...
    def __init__(self):
        ...
        # Store paths inside the instance
        ...
        # Load existing data or initialize empty dicts
    ...
    def _load_patch_data(self, file_path: str, default: Dict) -> Dict:
        ...
        if not os.path.exists(file_path):
            return default  # Return empty structure if file does not exist
        ...
        try:
            ...
            logger.error(f"⚠️ Error loading {file_path}: {e}. Resetting.")
            return default
