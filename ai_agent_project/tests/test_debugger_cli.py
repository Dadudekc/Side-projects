...
class TestDebuggerCLI(unittest.TestCase):
    ...
    @patch("agents.core.debugger_cli.json.load")
    ...
    @patch("agents.core.debugger_cli.json.load", return_value={})
    @patch("builtins.open", create=True)
    ...
    @patch("agents.core.debugger_core.DebuggerCore.debug_file", return_value="Debugging Successful")
    ...
    @patch("agents.core.debugger_core.DebuggerCore.debug", return_value="Full Debugging Successful")
    def test_run_debugger_full(self, mock_debug):
        """Test running the full debugging process."""
        self.cli.run_debugger()
        mock_debug.assert_called()

    @patch("agents.core.debugger_core.DebuggerCore.show_logs")
    def test_show_logs(self, mock_show_logs):
        """Test displaying debugging logs."""
        self.cli.show_logs()
        mock_show_logs.assert_called()

    @patch("agents.core.debugger_core.DebuggerCore.get_last_modified_files", return_value=["file1.py", "file2.py"])
    @patch("agents.core.debugger_core.DebuggerCore.rollback_changes")
    ...
    @patch("agents.core.debugger_core.DebuggerCore.get_last_modified_files", return_value=[])
    def test_rollback_fixes_no_changes(self, mock_get_last_modified_files):
        """Test rolling back fixes when no modifications exist."""
        self.cli.rollback_fixes()
        mock_get_last_modified_files.assert_called()

    @patch("agents.core.patch_tracking_manager.PatchTrackingManager.import_fixes", return_value={})
    ...
    @patch("agents.core.patch_tracking_manager.PatchTrackingManager.import_fixes",
    ...
    @patch("agents.core.debugger_cli.DebuggerCLI.run_debugger")
    ...
    @patch("agents.core.debugger_cli.DebuggerCLI.show_logs")
    ...
    @patch("agents.core.debugger_cli.DebuggerCLI.rollback_fixes")
    ...
    @patch("agents.core.debugger_cli.DebuggerCLI.show_ai_performance")
    ...
    @patch("agents.core.debugger_cli.DebuggerCLI.fix_imports")
